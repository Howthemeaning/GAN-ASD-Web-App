...
public class CuratorInstanceImpl implements CuratorInstance {
    ...
    private void initialize() throws Exception {
        ...
        if (StringUtils.isEmpty(curatorConfig.getConnectString())) {
            throw new Exception("connectString can't be null or empty");
        }
        ...
        switch (retryTypeEnum) {
            ...
            default:
                throw new Exception("Invalid config value for retryType=" + curatorConfig.getRetryType());
        }
     ...
     * @param retryPolicy
     */
    private void create(String namespace, String connectString, int sessionTimeoutMs, int connectionTimeoutMs, RetryPolicy retryPolicy) throws Exception {
        log.info("Start to initialize Curator..");

        if (curatorFramework != null) {
            throw new Exception("Curator isn't null, it has been initialized already");
        }
    ...
    public void validateStartedStatus() throws Exception {
        if (curatorFramework == null) {
            throw new Exception("Curator isn't initialized");
        }

        if (!isStarted()) {
            throw new Exception("Curator is closed");
        }
    }
    ...
    public void validateClosedStatus() throws Exception {
        ...
        if (isStarted()) {
            throw new Exception("Curator is started");
        }
    }
